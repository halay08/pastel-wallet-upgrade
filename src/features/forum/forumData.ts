...
const avatars = [svg_oval_1, svg_oval_2, svg_oval_3, svg_oval_4, svg_oval_5, svg_oval_6, svg_oval_7];
...
export const data = [
  ...
  {
    topic: 'Crypto CEO dies with password to unlock $200+ million of customers’ Bitcoin',
    favorite: faker.random.number(1),
    members: generateMembers(faker.random.number(12)),
    replies: {
      value: faker.random.number(10) * 100,
  ...
  {
    topic: 'Father of Parkland victim responds to Louis CK’s jokes with a “standup set”',
    favorite: faker.random.number(1),
    members: generateMembers(faker.random.number(12)),
    replies: {
      value: faker.random.number(10) * 100,
